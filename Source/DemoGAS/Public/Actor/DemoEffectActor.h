...
protected:
	...
	void OnBeginOverlap(AActor* EffectTargetActor);
	UFUNCTION(BlueprintCallable)
	void OnEndOverlap(AActor* EffectTargetActor);
	//~end

	UFUNCTION(BlueprintCallable)
	void ApplyGameplayEffectToTarget(AActor* EffectTargetActor, TSubclassOf<UGameplayEffect> GameplayEffectClass);
